    ...
    try {
      const response = await fetch("https://formspree.io/f/xyzypwwg", {
        ...
        body: JSON.stringify({
          ...
          _subject: `New AI Project Inquiry from ${contactForm.firstName} ${contactForm.lastName}`,
        }),
      });
      ...
      <section id="contact" className="py-20 bg-[#1a2744] text-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          {submitStatus === "success" && (
            <div className="mb-6 p-4 bg-green-500/20 border border-green-400 text-green-300 rounded-lg text-center">
              Thank you! Your message has been sent successfully. We'll get back to you soon.
            </div>
          )}

          {submitStatus === "error" && (
            <div className="mb-6 p-4 bg-red-500/20 border border-red-400 text-red-300 rounded-lg text-center">
              There was an error sending your message. Please try again or contact us directly at info@1dev.ai.
            </div>
          )}
          ...
          <form className="space-y-6" onSubmit={handleContactSubmit}>
            ...
            <Button
              ...
              className="w-full bg-[#25375d] hover:bg-[#2d4a78] text-white py-6 text-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="mt-20 pt-12 border-t border-white/20 max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/saas-tools" className="text-white/80 hover:text-white transition-colors">SaaS Tools</Link></li>
            ...
            <div>
              ...
              <div className="mt-4 text-sm">
                <p className="text-white/80">Email: info@1dev.ai</p>
