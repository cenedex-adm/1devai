        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12 p-8 bg-white rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-700 leading-relaxed">
                You can opt out of promotional emails by using the unsubscribe link included in our emails or by contacting us at <a href="mailto:info@1dev.ai" className="text-[#25375d] hover:underline font-medium">info@1dev.ai</a>. Note: Even if you opt out of marketing communications, we may still send non-promotional messages (e.g., project updates, quote follow-ups, or communications related to services you've requested).
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@1dev.ai" className="text-white/80 hover:text-white transition-colors">
                      info@1dev.ai
                    </a>
                  </div>
                </div>
