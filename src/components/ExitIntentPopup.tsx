    ...
    try {
      const response = await fetch("https://formspree.io/f/xyzypwwg", {
        ...
        body: JSON.stringify({
          name,
          email,
          _subject: `Exit Intent - Free Consultation Request from ${name}`,
          ...
          <div className="relative z-10">
            {submitStatus === "success" ? (
              <div className="text-center py-8">
                ...
                <p className="text-white/80">We'll send you exclusive insights and offers.</p>
              </div>
            ) : (
              <>
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                  {submitStatus === "error" && (
                    <div className="p-3 bg-red-500/20 border border-red-400/50 text-red-200 rounded-md text-sm text-center">
                  ...
                  <div className="flex gap-3 pt-2">
                    <Button
                      type="submit"
                      disabled={isSubmitting}
                      className="flex-1 bg-white text-[#25375d] hover:bg-gray-100 font-semibold py-6 text-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    >
